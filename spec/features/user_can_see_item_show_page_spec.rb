...
# binding.pry
      ...
      expect(page).to have_content("Merchant: #{merchant_1.username}")
    ...
    context "the viewer is a visitor or registered user" do
      it "shows a link to add item to the cart" do
        merchant_1 = User.create(username: "Scary Spice", email: "scary@spicegirls.com", password_digest: "dontbescared", address: "123 Thames Street", city: "London", state: "NY", zip: 12345, role: 0, active: 1)
